...
mkdir -p $input_raw_dir/Dataset124_ISIC2018
mkdir -p $input_pre_dir/Dataset124_ISIC2018
mkdir -p $output_dir_tmp/Dataset124_ISIC2018
...
/afs/crc.nd.edu/user/y/ypeng4/nnUNet/nnunetv2/run/run_training.py 124 2d 0 \
