...
class nnUNetDataset(object):
    ...
    def load_case(self, key):
        entry = self[key]
        # print('open_data_file' in entry.keys())
        # print(isfile(entry['data_file'][:-4] + ".npy"))
        # print('open_seg_file' in entry.keys())
        # print(isfile(entry['data_file'][:-4] + "_seg.npy"))
        # print('seg_from_prev_stage_file' in entry.keys())
        ...
        if 'open_data_file' in entry.keys():
            ...
            # data = np.load(entry['data_file'][:-4] + ".npy").astype(np.float)
            # print(type(data))
        ...
        if 'open_seg_file' in entry.keys():
            ...
            # seg = np.load(entry['data_file'][:-4] + "_seg.npy").astype(np.int)
            # print(type(seg))
            if self.keep_files_open:
        ...
        # print(type(data), type(seg), type(entry['properties']))
