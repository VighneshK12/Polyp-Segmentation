...
class Res2Network(nn.Module):
    ...
    def __init__(self, channel=32, n_classes=1, deep_supervision=True):
        ...
        from nnunetv2.training.network.model.dim2.res2net.Res2Net_v1b import res2net50_v1b_26w_4s
        ...
        self.deconv2 = nn.ConvTranspose2d(channel, channel, kernel_size=3, stride=1, padding=1,
                                          bias=False)
...
if __name__ == "__main__":
    model = Res2Network(n_classes=2, deep_supervision=True, channel=64)
