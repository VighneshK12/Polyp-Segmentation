...
# /afs/crc.nd.edu/user/y/ypeng4/nnUNet/nnunetv2/training/network/model/dim2/utils.py
from nnunetv2.training.network.model.dim2.utils import get_block
...
if __name__ == "__main__":
    model = UNetPlusPlus(in_ch=3, num_classes=1)
    times = []
    import time
