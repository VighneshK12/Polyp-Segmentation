...
class UNet(nn.Module):
    def __init__(self, in_ch, num_classes, base_ch=16,
        ...
        super().__init__()
        print("using vallina unet".center(30, "="))
        ...
        self.seg_0 = nn.Conv2d(base_ch * 32, num_classes, 1, 1, 0, bias=True)
...
if __name__ == "__main__":
    ...
    net = UNet(in_ch=3, num_classes=2, block="FusedMBConv", use_my_net=True)   # .cuda()
    y = net(x)
    print(y[0].shape)
