...
class ExperimentPlanner(object):
    ...
    def determine_fullres_target_spacing(self) -> np.ndarray:
        """
        per default we use the 50th percentile=median for the target spacing. Higher spacing results_1 in smaller data
        and thus faster and easier training. Smaller spacing results_1 in larger data and thus longer and harder training
