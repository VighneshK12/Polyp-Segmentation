...
def compute_2d_f1(mask_ref: np.ndarray, mask_pred: np.ndarray):
    slices = mask_ref.shape[0]
    f1_scores = []
    for s in slices:
        slice_ref = mask_ref[s]
        slice_pred = mask_pred[s]
...
def compute_metrics(reference_file: str, prediction_file: str, image_reader_writer: BaseReaderWriter,
    ...
    for r in labels_or_regions:
        ...
        # slice_f1_score = compute_2d_f1(mask_ref, mask_pred)
        if tp + fp + fn == 0:
        ...
        # results_1['metrics'][r]['slice_f1_score'] = slice_f1_score
    return results
...
if __name__ == '__main__':
    ...
    folder_pred = '/home/fabian/results_1/nnUNet_remake/Dataset004_Hippocampus/nnUNetModule__nnUNetPlans__3d_fullres/fold_0/validation'
    output_file = '/home/fabian/results_1/nnUNet_remake/Dataset004_Hippocampus/nnUNetModule__nnUNetPlans__3d_fullres/fold_0/validation/summary.json'
