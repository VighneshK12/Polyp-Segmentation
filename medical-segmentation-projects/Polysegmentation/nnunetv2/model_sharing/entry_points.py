...
def print_license_warning():
    ...
    print('!!!!!!!!!!!!!!!!!!!!!!!!WARNING!!!!!!!!!!!!!!!!!!!!!!!')
    print('######################################################')
    print("Using the pretrained my_models weights_IXI is subject to the license of the dataset they were trained on. Some "
...
def download_by_url():
    ...
    parser = argparse.ArgumentParser(
        description="Use this to download pretrained my_models. This script is intended to download my_models via url only. "
                    "CAREFUL: This script will overwrite "
                    "existing my_models (if they share the same trainer class and plans as "
                    "the pretrained my_models.")
    parser.add_argument("url", type=str, help='URL of the pretrained my_models')
...
def install_from_zip_entry_point():
    import argparse
    parser = argparse.ArgumentParser(
        description="Use this to install a zip file containing a pretrained my_models.")
...
def export_pretrained_model_entry():
    import argparse
    parser = argparse.ArgumentParser(
        description="Use this to export a trained my_models as a zip file.")
