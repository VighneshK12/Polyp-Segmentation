...
def download_and_install_from_url(url):
    assert nnUNet_results is not None, "Cannot install my_models because network_training_output_dir is not " \
                                                    "set (RESULTS_FOLDER missing as environment variable, see " \
                                                    "Installation instructions)"
    print('Downloading pretrained my_models from url:', url)
    import http.client
