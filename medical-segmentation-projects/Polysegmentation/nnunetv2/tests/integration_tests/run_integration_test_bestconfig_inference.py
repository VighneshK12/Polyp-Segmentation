...
if __name__ == '__main__':
    ...
    for im in ret['best_model_or_ensemble']['selected_model_or_models']:
        ...
        # note that if the best my_models is the enseble of 3d_lowres and 3d cascade then 3d_lowres will be predicted
    ...
    # if we have an ensemble, we need to ensemble the results_1
    if has_ensemble:
